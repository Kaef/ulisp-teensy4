...
#elif defined(__IMXRT1062__) //TEENSY40
...
object *sp_withspi (object *args, object *env) {
    ...
    #if defined(__IMXRT1062__) // TEENSY40
...
void setup () {
    ...
    initenv();
    initsleep();
    pfstring(PSTR("uLisp 2.8 - compiled: "), pserial);
    pfstring(__DATE__, pserial); pfstring(PSTR(" "), pserial);
    pfstring(__TIME__, pserial); pln(pserial);
}
